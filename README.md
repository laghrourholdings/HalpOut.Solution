...
├── IObject                         ├── IObject
  -> LogHandleId: 0xDEADBEEF -->      -> LogHandleId: 0xDEADBEEF
│   ├── IUser                       │   ├── IMedia
Of course this example will not be seen in practice, but it shows that the architecture gives the developer great flexiblity on the 
